                ...
                <div class="col-md-14 articles" id="site-content">
                    <article class="posts">
                        ...
                        <div class="content">
                            ...
                            curl_setopt($curl, CURLOPT_URL, 'https://api.disneyapi.dev/characters/308');
                            $res = curl_exec($curl);
                            ...
                            print("<img src=https://static.wikia.nocookie.net/disney/images/1/15/Arianna_Tangled.jpg >");
                            print("<br>");
                            ?>
                            </div>
